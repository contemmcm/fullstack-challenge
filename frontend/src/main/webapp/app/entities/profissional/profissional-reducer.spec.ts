...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROFISIONAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROFISIONAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROFISIONAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROFISIONAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROFISIONAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROFISIONAL actions', async () => {
      const expectedActions = [
        {
