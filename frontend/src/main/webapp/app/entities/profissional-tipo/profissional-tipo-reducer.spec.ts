...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './profissional-tipo.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROFISSIONALTIPO_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROFISSIONALTIPO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROFISSIONALTIPO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROFISSIONALTIPO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROFISSIONALTIPO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROFISSIONALTIPO actions', async () => {
      const expectedActions = [
        {
